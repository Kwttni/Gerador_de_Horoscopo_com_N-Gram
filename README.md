...
A aplicação possui uma interface interativa desenvolvida com <strong>Gradio</strong>, permitindo que o usuário selecione seu signo e gere uma previsão automaticamente.
...
<ul>
<li><strong>src/app.py</strong> — Interface da aplicação com Gradio</li>
...
<pre>
cd Gerador_de_Horoscopo_com_N-Gram.git
</pre>
...
Isso permite gerar textos com estrutura semelhante aos dados utilizados no treinamento.
